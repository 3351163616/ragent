...
COMMENT ON COLUMN t_eval_suite.create_time IS '创建时间';
COMMENT ON COLUMN t_eval_suite.update_time IS '更新时间';
...
COMMENT ON COLUMN t_eval_case.create_time IS '创建时间';
COMMENT ON COLUMN t_eval_case.update_time IS '更新时间';
