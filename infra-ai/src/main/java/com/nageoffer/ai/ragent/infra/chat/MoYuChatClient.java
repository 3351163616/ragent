...
@Slf4j
@Service
public class MoYuChatClient extends AbstractOpenAIStyleChatClient {
    ...
    public String provider() {
        return ModelProvider.MOYU.getId();
    }

    @Override
    @RagTraceNode(name = "moyu-chat", type = "LLM_PROVIDER")
    public String chat(ChatRequest request, ModelTarget target) {
        return doChat(request, target);
    }

    @Override
    @RagTraceNode(name = "moyu-stream-chat", type = "LLM_PROVIDER")
